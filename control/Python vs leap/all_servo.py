...
class LeapMotionListener(Leap.Listener):
    ...
    def on_exit(self, controller):
        ...
        self.a.motor_write(self.motor5, 200)
        self.a.motor_write(self.motor6, 90)
        self.a.motor_write(self.motor3, 3300)
