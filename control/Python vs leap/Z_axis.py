...
class SampleListener(Leap.Listener):
    ...
    def on_exit(self, controller):
        ...
        self.a.motor_write(self.motor4, 3500) 
        time .sleep(3)
        self.a.close()
    ...
    def on_frame(self, controller):
        ...
        self.newtime = time.time()
        if self.newtime-self.oldtime > 0.5: # if difference between times is 10ms
            ...
            for hand in frame.hands:
                ...
                ZPOS_stepper = -self.ZPOS*6500+3500


                self.a.motor_write(self.motor4,int(ZPOS_stepper))
