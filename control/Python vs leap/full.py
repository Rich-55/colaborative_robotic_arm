...
class LeapMotionListener(Leap.Listener):
	...
	def on_exit(self, controller):
		...
		self.a.motor_write(self.PIN2,90) # Az
		self.a.motor_write(self.PIN3,180) # Alt
		self.a.motor_write(self.PIN4,100) # Wrist
		self.a.motor_write(self.PIN5,70) # Claw
		self.a.close()
	...
	def on_frame(self, controller):
		...
		# Get the most recent frame and report some basic information
			...
			if normalized_point:
				...
				self.a.motor_write(self.PIN2,int(XPOS_servo)) # Azimuth
				self.a.motor_write(self.PIN3,int(YPOS_servo)) # Altitude
				self.a.motor_write(self.PIN4,int(ZPOS_servo)) # Wrist

				# claw range
				CLAW_SERVO = abs(90-dist_norm*70)
				print 'Claw Angle =',CLAW_SERVO
			
				self.a.motor_write(self.PIN5,int(CLAW_SERVO))
